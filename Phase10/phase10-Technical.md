...
<h3 dir="rtl"><span style="font-size:18px">در ابتدا <strong>ogma </strong>را داخل انگولار امتحان کنید و برای پیاده سازی آن به فایل  providing-ogma در همین ریپو مراجعه کنید.</span></h3>
